...
class workerpost_deletedPopUp_screen : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        val v : View = inflater!!.inflate(R.layout.fragment_workerpost_deleted_pop_up_screen, container, false)
        return  v
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        okay_btn.setOnClickListener{
            ...
            if(checkbox){
                ...
                val call = simpleAPI.userworkerpostDelete(email_str,user_str,jobTitle_str)
